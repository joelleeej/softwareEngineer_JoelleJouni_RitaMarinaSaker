...
class VisualizationProcessor:
    ...
    def visualize_sentiment_analysis(self, videos_df, comments_df):
        ...
        video_sentiment_path = os.path.join(
            self.static_dir, "video_sentiment_distribution.png"
        )
        ...
        plt.xlabel("Sentiment Score")
        plt.ylabel("Frequency")
        comments_sentiment_path = os.path.join(
            self.static_dir, "comments_sentiment_distribution.png"
        )
    ...
    def visualize_topics(self, videos_df):
        ...
        ]  # Adjust based on actual topic columns
        ...
        topic_distribution_path = os.path.join(
            self.static_dir, "topic_distribution.png"
        )
